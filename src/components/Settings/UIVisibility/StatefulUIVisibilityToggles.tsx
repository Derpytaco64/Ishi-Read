...
// visibility" family of settings. `?? true` defaults every new toggle to visible -- see
// UIElementVisibility's own comment in globalPreferencesReducer.ts.
export const StatefulUIVisibilityToggles = () => {
  ...
  return (
    ...
    <StatefulSwitch
      ...
      isSelected={ uiElementVisibility?.backLink ?? true }
    />
    <StatefulSwitch
      standalone
      ...
      isSelected={ uiElementVisibility?.runningHead ?? true }
    />
    <StatefulSwitch
      standalone
      ...
      isSelected={ uiElementVisibility?.readingTimer ?? true }
    />
    <StatefulSwitch
      standalone
      ...
      isSelected={ uiElementVisibility?.overflowMenu ?? true }
    />
    <StatefulSwitch
      standalone
      ...
      isSelected={ uiElementVisibility?.progression ?? true }
    />
    <StatefulSwitch
      standalone
      ...
      isSelected={ uiElementVisibility?.pagination ?? true }
    />
    </>
  );
};
